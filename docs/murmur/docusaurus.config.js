...
const config = {
  title: 'Murmur',
  tagline: 'A keyless crypto wallet',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://murmur.idealabs.network',
  ...
  organizationName: 'ideal-lab5', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Discord',
                href: 'https://discord.gg/phZvQkzU2a',
              },
              {
                label: 'Twitter',
      ...
      colorMode: {
        ...
        // disableSwitch: true,  // Disable the switch if you only want dark mode
      },
    }),
};
